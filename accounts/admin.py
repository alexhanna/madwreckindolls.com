from accounts.models import Skater, SkaterStatus, SkateSession, SkateSessionPaymentSchedule, SkateSessionPaymentAmount
...
class SkaterUserAdmin(UserAdmin):
...
admin.site.register(Skater, SkaterUserAdmin)
